...
class Doujin extends events_1.EventEmitter {
    constructor(id) {
        ...
        this.fetch = () => __awaiter(this, void 0, void 0, function* () {
            const result = yield fetcher_1.default('get')(this._url, 'json');
            this._info = parse_1.default(result, this._url);
            return this.info;
        });
        this.pdf = (filename) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!this._info)
                yield this.fetch();
            const PDF = new PDF_1.Document((_a = this._info) === null || _a === void 0 ? void 0 : _a.pages, 'A4');
