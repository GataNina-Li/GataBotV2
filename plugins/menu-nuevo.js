...
conn.send3ButtonImg(m.chat, pp, menu, '🐈 𝙂𝙖𝙩𝙖 𝘿𝙞𝙤𝙨 🐈', 'Ⓜ️ *MENÚ COMPLETO* Ⓜ️', `#mcompleto`, '🔖 *_INFORMACIÓN DEL MENÚ_* 🔖', `#menuinfobot`, '🎮 *_MENÚ DE JUEGOS_* 🎮', `menujuego`, m, false, { contextInfo: { mentionedJid }})   
}
