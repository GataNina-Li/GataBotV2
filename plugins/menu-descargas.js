...
conn.send3ButtonImg(m.chat, pp, menu, '𝙂𝙖𝙩𝙖 𝘿𝙞𝙤𝙨', '🔐 *_GESTIÓN DE GRUPO_* 🔐', `#menugrupo`, '🎨 *_MENÚ DE CREACIÓN_* 🎨', `#menucreador`, '🪅 *_ANIME/RANDOMS_* 🪅', `#menurandom`, m, false, { contextInfo: { mentionedJid }})   
}
