    ...
    constructor(pages, size = 'A4') {
        ...
        this.build = () => __awaiter(this, void 0, void 0, function* () {
            ...
            yield new Promise((resolve) => {
                this.pages.forEach((image, index) => __awaiter(this, void 0, void 0, function* () {
                    const file = fs_1.existsSync(image) ? image : yield download_1.default(image);
            ...
            document.end();
            const filename = `${os_1.tmpdir()}/${this.size}_${Math.random().toString()}.pdf`;
